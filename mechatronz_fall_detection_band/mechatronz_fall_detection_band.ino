#include <Wire.h>
 ...
 int angleChange = 0;
 // WiFi network info.
 char auth[] = "f4dE_Llj8ZswXCYfF7P34DQo_A37PEpj"; //Auth code sent via Email
 const char *ssid = "ARUL"; // Enter your Wi-Fi Name
 const char *pass = "arul2004"; // Enter your Wi-Fi Password
 void setup() {
   Serial.begin(115200);
